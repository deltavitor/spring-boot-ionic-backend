...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.apis(RequestHandlerSelectors.basePackage("com.vitor.cursomc.resources")).paths(PathSelectors.any())
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do curso Spring Boot",
				...
				"https://www.udemy.com/terms", new Contact("Vitor", "", ""), "Permitido uso para estudantes",
