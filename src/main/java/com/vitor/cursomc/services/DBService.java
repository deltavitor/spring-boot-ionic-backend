...
public class DBService {
	...
	public void instantiateTestDatabase() throws java.text.ParseException {
		...
		cat3.getProdutos().addAll(Arrays.asList(p9, p10));
		...
		Cliente cli2 = new Cliente(null, "Ana Costa", "ana@gmail.com", "64327878588", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("96544123", "74589632"));
		cli2.addPerfil(Perfil.ADMIN);

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "28220834", cli1, c1);
